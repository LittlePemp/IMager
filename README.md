...
Оригинал конвертируется в RGBA с установленным альфа-канало 120/256, что дает такой результат:
...
3. 100 картинок
### [1] Степень шума.
Степень шума - вашный параметр, используемы для сборки картинки.
...
<img src = "readme_content/1.png"></details>
