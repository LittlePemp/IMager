...
2. Либо напрямую изменить каждое поле и также иcкать близжайшее:<br>$RGB^*(r ± randint(rand3),$<br>    $g ± randint(rand3),$<br>    $b ± randint(rand3))$<br> где $rand3 \simeq \sqrt[3]{(rand2)}$.
